...
uses     forms, JvToolEdit, JvComponentBase, JvFormPlacement,
  JvAppStorage, JvAppIniStorage, ExcelXP,Winapi.Messages, SysUtils, Variants, Classes,
  AccessXP,  FMTBcd, DBClient, Provider, DBXCommon,
  SqlExpr, DB, Controls, Grids, DBGrids, StdCtrls, Mask, Data.DbxSqlite,
  Data.DBXPool, JvExMask, Bde.DBTables, Data.Win.ADODB ;
...
ADOConnection2.Connected:=true;
     ...
     ADOQuery1.SQL.Clear;
            ADOQuery1.SQL.Add('SELECT * INTO db6.mdb FROM sklad');
